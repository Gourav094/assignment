        ...
        <div className='py-14 px-3 md:px-[12%] text-gray-900'>
            <div className='md:flex gap-20'>
                <div className='md:w-2/5'>
                    ...
                    <div className='hidden my-8 px-4 rounded-lg bg-gray-50 md:flex justify-between items-center'>
                ...
                <div>
                    <div className='md:hidden my-8 px-4 rounded-lg bg-gray-50 flex justify-between items-center'>
                        <div className=' py-4 font-semibold'>
                            <p className=' pb-4 text-lg'>Still need help?<br /> We’re here for you.</p>
                            <button className='bg-black text-white rounded-lg py-3 px-4'>Chat with us</button>
                        </div>
